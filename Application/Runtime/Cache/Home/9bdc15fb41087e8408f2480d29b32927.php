					...
					<form action="/Home/SkuDetail/update" method="post" enctype="multipart/form-data" class="form-horizontal ">
		                ...
		                <div class="form-group">
		                    ...
		                    <div class="col-md-6">
		                        ...
		                        <input type="hidden" id='is_electronic' name="" value="<?php echo ($data["is_electronic"]); ?>">
		                        <input type="hidden" id='is_powder' name="" value="<?php echo ($data["is_powder"]); ?>">
		                        <input type="hidden" id='is_liquid' name="" value="<?php echo ($data["is_liquid"]); ?>">
	                    </div>
						<br>
...
<script type="text/javascript">
	...
	var is_electronic = document.getElementById('is_electronic').value;
	if (is_electronic == 1) {
		$("input:checkbox[name='is_electronic']").attr("checked",true);
	}

	var is_powder = document.getElementById('is_electronic').value;
	if (is_powder == 1) {
		$("input:checkbox[name='is_powder']").attr("checked",true);
	}

	var is_liquid = document.getElementById('is_liquid').value;
	if (is_liquid == 1) {
		$("input:checkbox[name='is_liquid']").attr("checked",true);
	}
</script>
