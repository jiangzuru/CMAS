	...
	<div class="row">
		<div class="col-lg-12">
			...
			<ol class="breadcrumb">
				...
				<li><i class="fa fa-indent"></i>计算成本</li>				
			</ol>
		</div>
	</div>
      <div class="row">
        <div class="col-lg-12">
          <div class="panel panel-default">
            <div class="panel-heading">
              <h2><i class="fa fa-table red"></i><span class="break"></span><strong><?php echo ($sku_data["sku"]); ?>成本表格</strong></h2>
            ...
            <div class="panel-body">
              <table class="table table-striped table-bordered" id="sku_table">
                  ...
                  <tbody>
                    <?php if(is_array($FBA_fee)): foreach($FBA_fee as $key=>$vo): ?><tr>
                      <th><?php echo ($vo["sale_domain"]); ?></th>
                      <th><?php echo ($vo["FBA_CNY"]); ?>(<?php echo ($vo["price"]); if($vo["sale_domain"] == '英国'): ?>£<?php else: ?>€<?php endif; ?>)</th>
                      <th><?php echo ($sku_data["paolv"]); ?></th>
                      <th><?php echo ($sku_data["buy_price"]); ?></th>
                      <th><?php echo ($sku_data["domestic_logistics_price"]); ?></th>
                      <th><?php echo ($sku_data["toucheng_price"]); ?></th>
                      <th><?php echo ($sku_data["package_price"]); ?></th>
                      <th><?php echo ($vo["sum"]); ?>(<?php echo ($vo["sum_foreign"]); if($vo["sale_domain"] == '英国'): ?>£<?php else: ?>€<?php endif; ?>)</th>
